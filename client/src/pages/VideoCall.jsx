...
const VideoCall = () => {
  ...
  const getPrediction = async () => {
    ...
    try {
      ...
      socketRef.current.emit("asl-prediction", {
        toSocketId: currentCallId,
        prediction,
      });
    } catch (error) {
                ...
                <div className="video-stream local">
                  ...
                  {localPrediction.class && (
                    <div className="prediction-badge local">
                      <p>
                        You: {localPrediction.class} (
                        {(localPrediction.confidence * 100).toFixed(2)}%)
                      </p>
                    </div>
                  )}
                </div>
                <div className="video-stream remote">
                  ...
                  {remotePrediction.class && (
                    <div className="prediction-badge remote">
                      <p>
                        Partner: {remotePrediction.class} (
                        {(remotePrediction.confidence * 100).toFixed(2)}%)
                      </p>
                    </div>
                  )}
                </div>
