      ...
      <section className="hero">
        <div className="container">
          <div className="hero-content">
            ...
            <p>
              Empowering communication with real-time ASL detection and
              translation
            </p>
        ...
        <div className="container">
          ...
          <div className="solution-grid">
            <div className="solution-card">
              ...
              <p>
                Real-time sign language recognition with deep learning
                technology
              </p>
            </div>
            <div className="solution-card">
        ...
        <div className="container">
          ...
          <div className="about-content">
            <div className="about-text">
              <p>
                At ASL Detector, we're passionate about making communication
                accessible to everyone. Our team of developers, researchers, and
                accessibility advocates work together to create innovative
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card">
              <div className="testimonial-content">
                <p>
                  "ASL Detector has transformed how I communicate at work. It's
            ...
            <div className="testimonial-card">
              <div className="testimonial-content">
                <p>
                  "As an educator, this tool has made my classroom more
      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="footer-bottom">
            <p>
              &copy; {new Date().getFullYear()} ASL Detector. All rights
              reserved.
            </p>
          </div>
        </div>
